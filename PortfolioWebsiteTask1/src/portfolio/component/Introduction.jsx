        ...
        <div className=' w-[70%] flex items-center'>
          <div className='flex flex-col items-center justify-center h-screen'>
            ...
            <div className='mt-5 flex space-x-5 items-center'>
              {/* GitHub Icon */}
              <a href='https://github.com/monsterguy123' target='_blank' className="h-12 w-12 fill-[#333]">
              ...
              {/* LinkedIn Icon */}
                <a href='https://www.linkedin.com/in/deepak-bisht-a37676224/' target='_blank' className="h-12 w-12 fill-[#0077b5]">
              ...
              {/* Twitter/X Icon */}
              <a href='https://x.com/DEEPAKB59847310' target='_blank' className="h-12 w-12 fill-black">
              ...
              {/* Discord Icon */}
              <a href="https://discord.com" className="h-12 w-12 fill-[#7289da]">
              ...
              {/*Gmail */}
              <a href='https://mail.google.com/' target='_blank' className="h-10 w-10 fill-[#ea4335]">
