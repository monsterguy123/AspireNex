...
const ContactMe = () => {
  ...
  return (
    <section className="body-font relative mt-20 bg-gray-50">
      ...
      <div className="w-full md:w-[60%] lg:w-1/2 hidden md:block">
          <img src={contactUs} alt="Customer Service" className="w-110 h-110 -mt-40 ml-32 rounded-lg"/>
        </div>
        <form className="w-full md:w-[50%]" onSubmit={onSubmit}>
          <div className="flex flex-col text-center w-full mb-12">
            <h1 className="sm:text-4xl text-xl font-medium title-font font-serif mb-4 text-gray-900 dark:text-white">WANT TO BE A PART OF <span className='underline font-semibold text-custom-purple'>QUIZZY</span> TEAM</h1>
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base font-serif dark:text-white">Send In your Resume to your hr team</p>
          </div>
          <div className="lg:w-2/3 md:w-full mx-auto">
            <div className="flex flex-wrap -m-2">
              ...
              <div className="p-2 w-full">
                <div className="relative">
                  <label htmlFor="name" className="leading-7 text-sm text-gray-600">Resume</label>
              ...
              <div className="p-2 w-full">
                <button type="submit" className="flex mx-auto text-white bg-fuchsia-900 border-0 py-2 px-8 focus:outline-none hover:bg-fuchsia-600 rounded text-sm font-bold">
                   SEND APPLICATION
                </button>
